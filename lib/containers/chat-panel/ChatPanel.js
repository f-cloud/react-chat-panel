...
var ChatPanel = function (_Component) {
  ...
  function ChatPanel(props) {
    ...
    _this.onChange = function (e) {
      _this.setState({ typedMessage: e.target.value });
      _this.props.onTyping(e);
    };
  ...
  _createClass(ChatPanel, [{
    ...
    value: function render() {
      var _props$styles = this.props.styles,
          themeColor = _props$styles.themeColor,
          titleTextColor = _props$styles.titleTextColor;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          this.props.messages.map(function (message, i) {
            return _react2.default.createElement(_Message2.default, _extends({ key: i
            }, message, {
              timestamp: (0, _moment2.default)(message.timestamp).fromNow()
            }));
          })
        ),
        _react2.default.createElement(_MessageInput2.default, _extends({}, this.props.styles, {
